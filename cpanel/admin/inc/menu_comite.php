  ...
  <ul class="vertical menu accordion-menu" data-accordion-menu data-submenu-toggle="true" >
    <li>
      ...
      <ul class="vertical menu nested"> -->
        ...
        <li><a href="propuestarPorCalificar.php?id_usuario=<?php echo $usuario ?>"><i class="fi-results"></i> Propuestas por calificar</a>
        <li><a href="propuestasCalificadas.php?id_usuario=<?php echo $usuario ?>"><i class="fi-results"></i> Propuestas calificadas</a>
