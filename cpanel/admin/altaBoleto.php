...
$insertarDatosBoletos = new Boletos();
$datos = $insertarDatosBoletos->guardarDatosBoletos($nombre, $nombre_ing, $modalidad, $preciomxn, $preciousd, $desde_format, $hasta_format, $hora_inicio, $hora_fin, $descripcion, $descripcion_ing, $congreso);
